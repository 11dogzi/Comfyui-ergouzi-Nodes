...
class EGTSCDSFGLNode:
    ...
    CATEGORY_KEYS = ['Graphic effects','Art style','Theme','Art style','Art unconventional','Illustration style','Artist','Film director','Coding method']
    ...
    def get_input_types_from_keys(keys):
        input_types = {}
        for key in keys:
            input_types[key] = (tuple(EGTSCDSFGLNode.get_options_keys(key)), {"default": "None"})
...
NODE_DISPLAY_NAME_MAPPINGS = { "EG_TSCDS_FG" : "2🐕Style category" }
